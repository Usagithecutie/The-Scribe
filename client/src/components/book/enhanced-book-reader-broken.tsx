  ...
  return (
    <div className="min-h-screen bg-background relative">
        ...
        <div className="container flex items-center justify-between h-16 px-4">
          <div className="flex items-center gap-4">
            ...
            <div className="flex items-center gap-2">
              ...
              <div>
                <h1 className="text-lg font-semibold">You Are A Poem And The World Is Reading You</h1>
                <p className="text-sm text-muted-foreground">by Zeke Iverson</p>
              </div>
            </div>
          </div>
          <div className="flex items-center gap-2">
      ...
      <div className="flex">
        ...
        <div className={`fixed inset-y-0 left-0 top-16 z-40 w-80 bg-card border-r transform transition-transform duration-300 ease-in-out ${
          ...
          <div className="flex flex-col h-full">
            ...
            <div className="p-4 border-b">
              ...
              <p className="text-sm text-muted-foreground mt-1">Navigate through chapters</p>
            </div>
