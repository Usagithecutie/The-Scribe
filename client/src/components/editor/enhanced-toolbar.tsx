  ...
  return (
    <div className="sticky top-0 z-10 bg-gradient-to-r from-slate-900/95 via-purple-900/95 to-slate-900/95 backdrop-blur-xl border-b border-border/50">
      ...
      <div className="flex items-center justify-center p-4">
        <div className="flex items-center gap-1 p-2 overflow-x-auto scrollbar-thin scrollbar-thumb-purple-500/30 bg-black/40 backdrop-blur-xl rounded-full border border-white/10 shadow-2xl max-w-full min-w-0">
          {/* File Operations */}
